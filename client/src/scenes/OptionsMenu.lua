...
function OptionsMenu:loadGeneralMenu()
  ...
  if system.isMobileLike() then
    generalMenuOptions[#generalMenuOptions+1] = ui.MenuItem.createToggleButtonGroupMenuItem("Mobile View (restart required)", nil, false, createToggleButtonGroup("portraitMode"))
  end
